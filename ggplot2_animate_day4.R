...
df <- read.csv("EAGLE_course_ggplot - Form responses 1.csv", header=T)
summary(df)
df
...
animate(a, renderer=gifski_renderer()) + anim_save("eagle_EO_vs_prog_experiences.gif", a)
